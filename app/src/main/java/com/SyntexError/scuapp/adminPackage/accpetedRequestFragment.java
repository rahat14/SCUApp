...
public class accpetedRequestFragment extends Fragment {
    ...
    public  accpetedRequestFragment(){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.add_product_page, container, false);
...
// setting up database and pointing to the item db
    ...
    private void loadData() {
        ...
        Query fireBaseQuery =  reqRef.orderByChild("status").equalTo("Completed") ;
